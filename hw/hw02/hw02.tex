...
[[\begin{figure}[H]
\centering
\includegraphics[width=300px]{img/q3/output-voltage-sketch.png}
\caption{\label{fig:output-voltage-sketch-q3}Output voltage sketch}
\end{figure}
\item Small-signal gain
\begin{figure}[H]
\centering
\includegraphics[width=300px]{img/q3/small-signal-sketch-q6.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=300px]{img/q3/small-signal-model-q3.pdf}

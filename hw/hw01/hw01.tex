...
\caption{\label{fig:cir1-vout-cal}Calculated \(V_{out}-V_{in}\)}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=.9\linewidth]{img/q7/a/cir1-vout-sim-cal.pdf}
\caption{\label{fig:cir1-vout-sim-cal}Simulated and calculated \(V_{out}-V_{in}\)}
\end{figure}
...
\item \(R_{out} = 4.73k\Omega\)
\begin{figure}[H]
\centering
\includegraphics[width=.9\linewidth]{img/q7/d/cir1-rout.pdf}
\caption{\label{fig:cir1-rout}\(R_{out}\) at \(V_{in} = 0.69V\)}
\end{figure}
\end{enumerate}

\item g\textsubscript{m} and g\textsubscript{ds}

...
\end{figure}
\item I\textsubscript{S}-V\textsubscript{GD}
\begin{figure}[H]
\centering
\includegraphics[width=.9\linewidth]{img/q3/a/pmos-is-vgd.pdf}
\caption{\label{fig:pmos-is-vgd}PMOS I\textsubscript{S}-V\textsubscript{GD}}
\end{figure}
\end{enumerate}
\end{enumerate}
...
\section{Problem 5}
\label{sec:orgeceb941}

\section{Problem 6}
\label{sec:orgc20ff4a}
\begin{enumerate}
